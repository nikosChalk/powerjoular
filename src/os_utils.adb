...
package body OS_Utils is
    ...
    begin
        ...
        return Platform_Name = "rbp4001.0-64" or else Platform_Name = "rbp4b1.4" or else Platform_Name = "rbp4b1.4-64" or else Platform_Name = "rbp3bplus1.3" or else Platform_Name = "rbp3bplus1.3-64" or else Platform_Name = "rbp4b1.2" or else Platform_Name = "rbp4b1.2-64" or else Platform_Name = "rbp4b1.1" or else Platform_Name = "rbp4b1.1-64" or else Platform_Name = "rbp4b1.2" or else Platform_Name = "rbp3b+1.3" or else Platform_Name = "rbp3b1.2" or else Platform_Name = "rbp2b1.1" or else Platform_Name = "rbp1b+1.2" or else Platform_Name = "rbp1b2" or else Platform_Name = "rbpzw1.1";
    end;
